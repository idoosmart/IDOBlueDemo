...
@interface PhotoDialManager : NSObject
...
///   - callback: 返回 WallpaperCloudLibModel｜ call back WallpaperCloudLibModel
...
/// - Parameters:
///   - wallpaperCloudLibManager: WallpaperCloudLibManager
...
///   - callback: 返回 表盘安装状态：IDOWallpaperWCInstallFaceLog, 制作的表盘包路径：wallpaperZipPath， 安装进度：progress   ｜ callback description   Dial dial install state: WallpaperWCInstallFaceLog, Make the dial package path: wallpaperZipPath, Dial installation progress: progress
