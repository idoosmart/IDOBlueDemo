...
@interface GetHealthSwitchViewModel()
...
@implementation GetHealthSwitchViewModel
...
- (void)getCellModels
{
    ...
    model.data = @[lang(@"get health switch state")];
