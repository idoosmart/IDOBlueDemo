...
@interface GetWalkReminderViewModel()
...
@implementation GetWalkReminderViewModel
...
- (void)getCellModels
{
    ...
    model.data = @[lang(@"get walk reminder")];
