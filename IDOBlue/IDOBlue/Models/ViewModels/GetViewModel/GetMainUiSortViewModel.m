//
//  GetMainUiSortViewModel.m
//  IDOBlue
//
//  Created by hedongyang on 2021/8/19.
...
@interface GetMainUiSortViewModel()
...
@implementation GetMainUiSortViewModel
...
- (void)getCellModels
{
    ...
    model.data = @[lang(@"get main ui sort")];
