...
#ifndef IDONetworkingConst_h
#define IDONetworkingConst_h
...
@class IDORequest, XMBatchRequest, XMChainRequest;
...
typedef void (^XMRequestConfigBlock)(IDORequest *request);
...
typedef void (^XMBCNextBlock)(IDORequest *request, id _Nullable responseObject, BOOL *isSent);
 ...
 */
typedef void (^XMCenterRequestProcessBlock)(IDORequest *request);
 ...
 */
typedef id _Nullable (^XMCenterResponseProcessBlock)(IDORequest *request, id _Nullable responseObject, NSError * _Nullable __autoreleasing *error);
...
/**
 ...
 @param error The error that occurred while the response data don't conforms to your own business logic.
 */
typedef void (^XMCenterErrorProcessBlock)(IDORequest *request, NSError * _Nullable __autoreleasing *error);

NS_ASSUME_NONNULL_END

#endif /* IDONetworkingConst_h */
