...
- (instancetype)init {
    ...
    _requestSerializerType = kXMRequestSerializerJSON;
...
- (BOOL)onFinishedOneRequest:(IDORequest *)request response:(id)responseObject error:(NSError *)error {
    BOOL isFinished = NO;
    XMLock();
...
@property (nonatomic, strong, readwrite) IDORequest *runningRequest;
...
- (XMChainRequest *)onFirst:(XMRequestConfigBlock)firstBlock {
    ...
    _runningRequest = [IDORequest request];
