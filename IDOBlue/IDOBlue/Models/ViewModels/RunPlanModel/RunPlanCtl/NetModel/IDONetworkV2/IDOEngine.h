 ...
 */
- (void)sendRequest:(IDORequest *)request completionHandler:(nullable XMCompletionHandler)completionHandler;
 ...
 */
- (nullable IDORequest *)cancelRequestByIdentifier:(NSString *)identifier;
 ...
 */
- (nullable IDORequest *)getRequestByIdentifier:(NSString *)identifier;
