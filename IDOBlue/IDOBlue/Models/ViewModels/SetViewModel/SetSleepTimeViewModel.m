...
@interface SetSleepTimeViewModel()
@property (nonatomic,strong)IDOSetSleepPeriodInfoBluetoothModel * sleepModel;
...
@implementation SetSleepTimeViewModel
...
- (IDOSetSleepPeriodInfoBluetoothModel *)sleepModel
{
    if (!_sleepModel) {
        _sleepModel = [IDOSetSleepPeriodInfoBluetoothModel currentModel];
    }
    return _sleepModel;
}
