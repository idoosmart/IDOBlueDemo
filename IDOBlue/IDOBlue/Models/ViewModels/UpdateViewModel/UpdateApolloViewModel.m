//
//  UpdateApolloViewModel.m
//  IDOBlue
//
//  Created by hedongyang on 2020/4/22.
...
@interface UpdateApolloViewModel()
...
@implementation UpdateApolloViewModel
...
- (void)getCellModels
{
    ...
    model1.data    = @[lang(@"apollo update")];
...
- (NSString *)selectedFileWithFilePath:(NSString *)filePath
{
    ...
    NSString * typeStr = [@"Type : "stringByAppendingString:@"apollo File"];
...
- (void)updateWordwithVc:(FuncViewController *)funcVC
{
    ...
    [funcVC showLoadingWithMessage:[NSString stringWithFormat:@"%@...",lang(@"apollo update")]];
    ...
    initTransferManager().fileName = @".fw";
