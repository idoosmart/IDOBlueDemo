...
/**
 ...
 all the data will be deleted after the migration.
 ⚠️If you do not pass the directory collection, except for the newly created directory of sdk, it will be deleted, so you will pass the directory name
 collection according to the development requirements.
 */
