 ...
 * @param callback 状态回调 (errorCode : 0 设置成功,其他值为错误,可以根据 IDOErrorCodeToStr 获取错误码str) | Status callback (errorCode : 0 set successfully, other values are wrong, you can get error code str according to IDOErrorCodeToStr)
 */
