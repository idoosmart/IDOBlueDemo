 ...
 * @param isSetParam 是否设置传输参数 默认 YES | is set transmission parameters default YES
...
/**
 * 初始化文件传输协议 | init file transfer protocol
 */
+ (void)idoProtocolDataTranInit;
