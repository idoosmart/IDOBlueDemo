...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IDOBlueUpdate",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13IDOBlueUpdate11DFUFirmware")
...
SWIFT_CLASS("_TtC13IDOBlueUpdate15DFUFirmwareSize")
...
SWIFT_PROTOCOL("_TtP13IDOBlueUpdate29DFUPeripheralSelectorDelegate_")
...
SWIFT_CLASS("_TtC13IDOBlueUpdate21DFUPeripheralSelector")
...
SWIFT_PROTOCOL("_TtP13IDOBlueUpdate19DFUProgressDelegate_")
...
SWIFT_CLASS("_TtC13IDOBlueUpdate20DFUServiceController")
...
SWIFT_PROTOCOL("_TtP13IDOBlueUpdate18DFUServiceDelegate_")
...
SWIFT_CLASS("_TtC13IDOBlueUpdate19DFUServiceInitiator")
...
SWIFT_CLASS("_TtC13IDOBlueUpdate25LegacyDFUServiceInitiator")
...
/// The Logger delegate.
SWIFT_PROTOCOL("_TtP13IDOBlueUpdate14LoggerDelegate_")
@protocol LoggerDelegate
...
SWIFT_CLASS("_TtC13IDOBlueUpdate25SecureDFUServiceInitiator")
@interface SecureDFUServiceInitiator : DFUServiceInitiator
- (DFUServiceController * _Nullable)start SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithCentralManager:(CBCentralManager * _Nonnull)centralManager target:(CBPeripheral * _Nonnull)target OBJC_DESIGNATED_INITIALIZER;
@end

enum ZipCompression : NSInteger;

/// Zip class
SWIFT_CLASS("_TtC13IDOBlueUpdate3Zip")
...
///   </li>
/// </ul>
/// \param zipFilePath Local file path of zipped file. NSURL.
///
/// \param destination Local file path to unzip to. NSURL.
///
/// \param overwrite Overwrite bool.
///
/// \param password Optional password if file is protected.
///
/// \param progress A progress closure called after unzipping each file in the archive. Double value betweem 0 and 1.
///
///
/// throws:
/// Error if unzipping fails or if fail is not found. Can be printed with a description variable.
+ (BOOL)unzipFile:(NSURL * _Nonnull)zipFilePath destination:(NSURL * _Nonnull)destination overwrite:(BOOL)overwrite password:(NSString * _Nullable)password error:(NSError * _Nullable * _Nullable)error progress:(void (^ _Nullable)(double))progress fileOutputHandler:(void (^ _Nullable)(NSURL * _Nonnull))fileOutputHandler;
/// Zip files.
/// <ul>
///   <li>
///     notes: Supports implicit progress composition
///   </li>
/// </ul>
/// \param paths Array of NSURL filepaths.
///
/// \param zipFilePath Destination NSURL, should lead to a .zip filepath.
///
...
///
/// throws:
/// Error if zipping fails.
+ (BOOL)zipFilesWithPaths:(NSArray<NSURL *> * _Nonnull)paths zipFilePath:(NSURL * _Nonnull)zipFilePath password:(NSString * _Nullable)password compression:(enum ZipCompression)compression error:(NSError * _Nullable * _Nullable)error progress:(void (^ _Nullable)(double))progress;
@end



typedef SWIFT_ENUM(NSInteger, ZipCompression, closed) {
  ZipCompressionNoCompression = 0,
  ZipCompressionBestSpeed = 1,
  ZipCompressionDefaultCompression = 2,
  ZipCompressionBestCompression = 3,
};
