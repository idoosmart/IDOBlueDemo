...
@property (strong, nonatomic, nonnull) UIImage *statusImage UI_APPEARANCE_SELECTOR;         // default is line rotate 自定义旋转
...
+ (void)setStatusImage:(nonnull UIImage *)image;                     // default is line rotate
